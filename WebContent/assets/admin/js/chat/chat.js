...
if(chat_use == "Y" && nowTimeStr < end_time && nowTimeStr > start_time) {
    ...
    //var webSocket = new WebSocket('ws://djid.ngelnet.com/broadcasting');
	    ...
	    switch(chatObj.mode) { 
	    	...
	    	case "getChatLog": {
	    		...
	    		if(chatObj.chatLog.length) {
	    			if(chatObj.roomInfo != "undefined" && chatObj.roomInfo != null){
	    				var USER_NAME = chatObj.roomInfo.USER_NAME != "undefined" && chatObj.roomInfo.USER_NAME != null ? chatObj.roomInfo.USER_NAME : "";
			    		var USER_PHONE = chatObj.roomInfo.USER_PHONE != "undefined" && chatObj.roomInfo.USER_PHONE != null ? chatObj.roomInfo.USER_PHONE : "";
			    		var USER_CATEGORY = chatObj.roomInfo.USER_CATEGORY != "undefined" && chatObj.roomInfo.USER_CATEGORY != null ? chatObj.roomInfo.USER_CATEGORY : "";
			    		var USER_STATUS = chatObj.roomInfo.USER_STATUS != "undefined" && chatObj.roomInfo.USER_STATUS != null ? chatObj.roomInfo.USER_STATUS : "";
			    		var USER_ADDRESS = chatObj.roomInfo.USER_ADDRESS != "undefined" && chatObj.roomInfo.USER_ADDRESS != null ? chatObj.roomInfo.USER_ADDRESS : "";
			    		
			    		if( USER_NAME != "" && USER_PHONE != "" && USER_CATEGORY != "" && USER_STATUS != "" && USER_ADDRESS != "" ){
			    			$("#adminChatRoom" + chatObj.cno).find("span.checkName").html(USER_NAME);
			    			$("#adminChatRoom" + chatObj.cno).find("span.checkSort").html(USER_CATEGORY);
			    			$("#adminChatRoom" + chatObj.cno).find("span.checkPhone").html(USER_PHONE);
			    			$("#adminChatRoom" + chatObj.cno).find("span.checkStatus").html(USER_STATUS);
			    			$("#adminChatRoom" + chatObj.cno).find("span.checkAddress").html(USER_ADDRESS);
			    			$("#adminChatRoom" + chatObj.cno).find("div.checkInfoDiv").show();
			    		} 
	    			}
	    	...
	    	case "msg": {
	    		...
	    		var checkName = chatObj.checkName != "undefined" && chatObj.checkName != null ? chatObj.checkName : ""; 
	    		var checkPhone = chatObj.checkPhone != "undefined" && chatObj.checkPhone != null ? chatObj.checkPhone : ""; 
	    		var checkSort = chatObj.checkSort != "undefined" && chatObj.checkSort != null ? chatObj.checkSort : ""; 
	    		var checkStatus = chatObj.checkStatus != "undefined" && chatObj.checkStatus != null ? chatObj.checkStatus : ""; 
	    		var checkAddress = chatObj.checkAddress != "undefined" && chatObj.checkAddress != null ? chatObj.checkAddress : ""; 
	    		
	    		//console.log("================================="); 
	    		//console.log("admin msg checkName : " + chatObj.checkName);
	    		//console.log("admin msg checkPhone : " + chatObj.checkPhone);
	    		//console.log("admin msg checkSort : " + chatObj.checkSort);
	    		//console.log("admin msg checkStatus : " + chatObj.checkStatus);
	    		//console.log("admin msg checkAddress : " + chatObj.checkAddress);
	    		//console.log("=================================");
	    		  
	    		if( checkName != '' && checkPhone != '' && checkSort != '' && checkStatus != '' && checkAddress != '' ){
	    			$("#adminChatRoom" + chatObj.cno + " span.checkName").html(checkName);
	    			$("#adminChatRoom" + chatObj.cno + " span.checkPhone").html(checkPhone);
	    			$("#adminChatRoom" + chatObj.cno + " span.checkSort").html(checkSort);
	    			$("#adminChatRoom" + chatObj.cno + " span.checkStatus").html(checkStatus);
	    			$("#adminChatRoom" + chatObj.cno + " span.checkAddress").html(checkAddress);
	    			
	    			$("#adminChatRoom" + chatObj.cno + " div.checkInfoDiv").show();
	    		}
