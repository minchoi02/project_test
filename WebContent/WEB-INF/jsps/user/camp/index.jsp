...
<div id="wrapper">
    ...
    <header id="header" class="smooth">
        ...
        <nav id="gnb">
            <ul class="nopm floats">
                <li><a href="./member_list.do"><em><img src="/images/common/ico_people.svg" alt="Member"></em><span>Member</span></a></li>
                <li><a href="./recording.do"><em><img src="/images/common/ico_recording.svg" alt="Recording"></em><span>Recording</span></a></li>
	...
	<aside class="user-info">
		...
		<div class="sign-out-area">
			<a href="./login.do"><i class="far fa-power-off"></i></a>
		</div>
	</aside>
	<!-- } User Info -->
