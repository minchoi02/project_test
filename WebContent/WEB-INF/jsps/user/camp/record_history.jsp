    ...
    <header id="header" class="smooth">
        ...
        <nav id="gnb">
            <ul class="nopm floats">
                ...
                <li><a href="./videoclip.do"><em><img src="/images/common/ico_mediaclip.svg" alt="Video Clip"></em><span>Video Clip</span></a></li>
                <li><a href="./setting.do"><em><img src="/images/common/ico_setting.svg" alt="Setting"></em><span>Setting</span></a></li>
            </ul>
        </nav>
        <!-- } GNB -->
    </header>
	...
	<div id="container">
		...
		<div class="tab-menu smooth">
			<ul class="nopm floats tab2">
				<li><a href="/camp/recording.do">Camera</a></li>
				<li class="active"><a href="./record_history.html">Record History</a></li>
			</ul>
		</div>
		<!-- } Tab Menu -->

		<section id="recordHistory" class="page-content">
            <div class="table-box">
                <table class="basic-tbl">
                    <colgroup>
                        <col width="10%" style="width: 6%;" />
                        <col />
                        <col />
                        <col />
                        <col width="10%" style="width: 10%;" />
                        <col />
                        <col width="10%" style="width: 7%;" />
                    </colgroup>
                    <thead>
                        <tr>
                            <th>No</th>
                    ...
                    <tbody>
                        <tr>
                            <td class="num">254</td>
                            <td class="start">00-00-2021 00:00</td>
                            <td class="end">00-00-2021 00:00</td>
                            <td class="total-time">00:00</td>
                            <td class="channel">6</td>
                            <td class="location">녹화장소명</td>
                            <td class="state"><span class="colorGreen">Finish</span></td>
                        </tr>
                        <tr>
                            <td class="num">254</td>
                            <td class="start">00-00-2021 00:00</td>
                            ...
                            <td class="channel">6</td>
                            <td class="location">녹화장소명</td>
                            <td class="state"><span class="colorRed">Error</span></td>
                        </tr>
                        <tr>
                            <td class="num">254</td>
                            <td class="start">00-00-2021 00:00</td>
