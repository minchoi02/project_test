	...
	<div id="container">
		...
		<div class="tab-menu smooth">
			<ul class="nopm floats tab2">
				<li class="active"><a href="/camp/videoclip.do">Unclassified</a></li>
				<li><a href="/camp/incording.do">Incording</a></li>
			</ul>
		</div>
		<!-- } Tab Menu -->

        <section id="unclassified" class="page-content">
            <div class="gallery-box floats">
            <c:if test="${!empty list}">
	            	<c:forEach var="list" items="${list}">
	                <div class="gallery-item">
	                    <a href="/camp/videoclip_view.do" class="pic"><img src="/images/sample_movie1.jpg" alt="" /></a>
	                    <a href="/camp/videoclip_view.do" class="txt">
                ...
                <!-- <div class="gallery-item">
                    <a href="/camp/videoclip_view.do" class="pic"><img src="/images/sample_movie2.jpg" alt="" /></a>
                    <a href="/camp/videoclip_view.do" class="txt">
                        <strong>United States Camp United States Camp United States Camp</strong>
                        <span class="date-clipnum">00-00-2021 00:00:00&nbsp;&nbsp;&nbsp;/&nbsp;&nbsp;&nbsp;Clip Video : 8</span>
                    </a>
                ...
                <div class="gallery-item">
                    <a href="/camp/videoclip_view.do" class="pic"><img src="/images/sample_movie3.jpg" alt="" /></a>
                    <a href="/camp/videoclip_view.do" class="txt">
                        <strong>United States Camp United States Camp United States Camp</strong>
                        <span class="date-clipnum">00-00-2021 00:00:00&nbsp;&nbsp;&nbsp;/&nbsp;&nbsp;&nbsp;Clip Video : 8</span>
                    </a>
                ...
                <div class="gallery-item">
                    <a href="/camp/videoclip_view.do" class="pic"><img src="/images/sample_movie4.jpg" alt="" /></a>
                    <a href="/camp/videoclip_view.do" class="txt">
                        <strong>United States Camp United States Camp United States Camp</strong>
                        <span class="date-clipnum">00-00-2021 00:00:00&nbsp;&nbsp;&nbsp;/&nbsp;&nbsp;&nbsp;Clip Video : 8</span>
                    </a>
                ...
                <div class="gallery-item">
                    <a href="/camp/videoclip_view.do" class="pic"><img src="/images/sample_movie5.jpg" alt="" /></a>
                    <a href="/camp/videoclip_view.do" class="txt">
                        <strong>United States Camp United States Camp United States Camp</strong>
                        <span class="date-clipnum">00-00-2021 00:00:00&nbsp;&nbsp;&nbsp;/&nbsp;&nbsp;&nbsp;Clip Video : 8</span>
                    </a>
                ...
                <div class="gallery-item">
                    <a href="/camp/videoclip_view.do" class="pic"><img src="/images/sample_movie6.jpg" alt="" /></a>
                    <a href="/camp/videoclip_view.do" class="txt">
                        <strong>United States Camp United States Camp United States Camp</strong>
                        <span class="date-clipnum">00-00-2021 00:00:00&nbsp;&nbsp;&nbsp;/&nbsp;&nbsp;&nbsp;Clip Video : 8</span>
                    </a>
                ...
                <div class="gallery-item">
                    <a href="/camp/videoclip_view.do" class="pic"><img src="/images/sample_movie7.jpg" alt="" /></a>
                    <a href="/camp/videoclip_view.do" class="txt">
                        <strong>United States Camp United States Camp United States Camp</strong>
                        <span class="date-clipnum">00-00-2021 00:00:00&nbsp;&nbsp;&nbsp;/&nbsp;&nbsp;&nbsp;Clip Video : 8</span>
                    </a>
                ...
                <div class="gallery-item">
                    <a href="/camp/videoclip_view.do" class="pic"><img src="/images/common/movie_noimg.png" alt="" /></a>
                    <a href="/camp/videoclip_view.do" class="txt">
                        <strong>United States Camp United States Camp United States Camp</strong>
                        <span class="date-clipnum">00-00-2021 00:00:00&nbsp;&nbsp;&nbsp;/&nbsp;&nbsp;&nbsp;Clip Video : 8</span>
                    </a>
