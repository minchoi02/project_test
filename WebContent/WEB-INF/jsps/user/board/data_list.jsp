                    ...
                    <div class="add-board">
                        ...
                        <table width="100%" class="add-board-style" border="0" cellspacing="0" cellpadding="0">
                            ...
                            <tr>
                                ...
                                <td><a href="./sub2_4_view.php?top=2&sub=4">디지털 엔지니어링 협업 플랫폼 이란?디지털 엔지니어링 협업 플랫폼 ...</a></td>
                        ...
                        <div class="text-right"><a class="mt50 sub_btn blue_btn" href="./sub2_4_write.php?top=2&sub=4">글쓰기</a></div>
                    </div>
                </div>
            </div>
        </div>
