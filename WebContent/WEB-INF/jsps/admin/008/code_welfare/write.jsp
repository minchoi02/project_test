							...
							<table  class="tbv" style="margin-top: 10px;"  summary="글입력하기">
								...
								<tbody>
									<tr>
										<th>상위코드</th>
										<td>
											<select name="type" id="type" style="width:200px;min-width:200px;" >
												<c:forEach var="list" items="${typeCodeList}">
													<option value="${list.TYPE}">${list.TYPE_DESC}</option>
												</c:forEach>
											</select>
										</td>
									</tr>
									<tr>
										<th>하위코드</th>
										<td><input type="text" name="code_desc" id="code_desc" value="" style="width: 200px;" /></td>
									</tr>
									<tr>
										<th>정렬순서</th>
										<td><input type="number" name="sort" id="sort" value="" style="width: 200px;" /></td>
									</tr>
								</tbody>
							</table>
