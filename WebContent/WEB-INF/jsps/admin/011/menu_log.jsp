...
<style>
	.sta_tbl tr td.text_left { text-align:left; }
</style>
...
<div id="contents_bg">
		...
		<div class="conBox">
				...
				<div class="T_basic">
						...
						<form name="searchForm" id="searchForm" method="post" action="/admin/011/menu/menu_log.do">
									...
									<table class="tbl sta_tbl" border="0" cellpadding="0" cellspacing="0" style="width: 95%;">
										...
										<tbody>											
											<c:if test="${empty list}">
												<tr>
													<td colspan="5" style="text-align:center;">접속기록이 없습니다.</td>
												</tr>
											</c:if>
											<c:if test="${!empty list}">
												<c:forEach var="list" items="${list}">
													<tr>
            											...
            											<td>${list.USER_IP }</td>
														<td class="text_left">${list.LINK }</td>
														<td>${list.REG_DATE }</td>
													</tr>
												</c:forEach>
											</c:if>
