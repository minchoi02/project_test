							...
							<table  class="tbv"  summary="공지사항 글입력하기">
								...
								<tbody>
										...
										<td>
											<select name="area_seq" id="area_seq" style="width: 200px;">
												<c:forEach var="list" items="${selType6List}" varStatus="status">
													<option value="${list.SEQ}" <c:if test="${list.SEQ eq view.AREA_SEQ}">selected</c:if>>${list.CODE_DESC}</option>
												</c:forEach>
											</select>										
										</td>
									</tr>
									<tr>
										<th>구분</th>
										<td>
											<c:forEach var="list" items="${selType30List}" varStatus="status">
												<label><input type="checkbox" name="kind_str" value="${list.SEQ}" <c:if test="${fn:contains(view.KIND_STR, list.SEQ)}">checked</c:if> /> ${list.CODE_DESC} </label> &nbsp;												
											</c:forEach>	
										</td>
									</tr>
									<tr>
										...
										<td>
											...
											<c:forEach var="list" items="${selType31List}" varStatus="status">
												<option value="${list.SEQ}" <c:if test="${list.SEQ eq view.KIND_SEQ}">selected</c:if>>${list.CODE_DESC}</option>												
											</c:forEach>
											</select>
										</td>
									</tr>
									<tr>
										<th>시설명</th>
										<td>
											<input type="text" name="name" id="fname" value="${view.NAME}" style="width: 250px;"/> 											
										</td>
									</tr>
									<tr>
										<th>연락처</th>
										<td>
											<input type="text" name="tel1" id="tel1" value="${view.TEL1}" style="width: 50px;"/>
											-
											<input type="text" name="tel2" id="tel2" value="${view.TEL2}" style="width: 50px;"/>
											-
											<input type="text" name="tel3" id="tel3" value="${view.TEL3}" style="width: 50px;"/> 											
										</td>
									</tr>
									<tr>
										<th>팩스번호</th>
										<td>
											<input type="text" name="fax1" id="fax1" value="${view.FAX1}" style="width: 50px;"/>
											-
											<input type="text" name="fax2" id="fax2" value="${view.FAX2}" style="width: 50px;"/>
											-
											<input type="text" name="fax3" id="fax3" value="${view.FAX3}" style="width: 50px;"/> 											
										</td>
									</tr>
									<tr>
										<th>주소</th>
									...
									<tr>
										<th>홈페이지</th>
										<td>
											<input type="text" name="domain" id="domain" value="${view.DOMAIN}" placeholder="http://를 빼고 입력해주세요." style="width: 250px;"/> 											
										</td>
									</tr>
									<tr>
										<th>시설이미지</th>
										<td>
											<input type="file" name="img1" id="img1" style="margin-top: 3px;" /> ${view.IMG1}
											<br/>
											<input type="file" name="img2" id="img2" style="margin-top: 3px;" /> ${view.IMG2}
											<br/>
											<input type="file" name="img3" id="img3" style="margin-top: 3px;" /> ${view.IMG3}
										</td>
									</tr>
								</tbody>
							</table>
