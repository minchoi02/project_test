							...
							<table  class="tbv"  summary="공지사항 글입력하기">
								...
								<tbody>
									...
									<tr>
										...
										<td>
											<c:forEach var="list" items="${selType30List}" varStatus="status">
												<label><input type="checkbox" name="kind_str" value="${list.SEQ}" /> ${list.CODE_DESC} </label> &nbsp;												
											</c:forEach>											
										</td>
									</tr>
									<tr>
									...
									<tr>
										<th>시설이미지</th>
										<td>
											<input type="file" name="img1" id="img1" style="margin-top: 3px;" />
											<br/>
											<input type="file" name="img2" id="img2" style="margin-top: 3px;" />
											<br/>
											<input type="file" name="img3" id="img3" style="margin-top: 3px;" />
										</td>
									</tr>
								</tbody>
							</table>
