...
$(document).ready(function(){
	...
	$('#check_drop').click(function () {
		...
		if(confirm("선택한 예약을 모두 삭제하시겠습니까?")){
			...
			$("#seq").val(seq);
			$("#frm").attr("action", "/admin/007/volunteer/check_volunteer_drop.do");
			$("#frm").submit();
		}
	});
...
<div id="contents_bg">
		...
		<div class="conBox">
				...
				<div class="T_basic">
						...
						<form name="searchForm" id="searchForm" method="post" action="/admin/007/volunteer/list.do">
									...
									<table class="tbl" border="0" cellpadding="0" cellspacing="0" style="width: 95%;">
										...
										<tbody>											
											<c:if test="${empty list}">
												<tr>
													<td colspan="5" style="text-align:center;">등록된 신청이 없습니다.</td>
												</tr>
											</c:if>
											<c:if test="${!empty list}">
									...
									<table style="width: 95%;">
										...
										<tr>
											<td align="right" style="padding-top:15px;">
												...
												<span class="button01"><a href="/admin/${bean.menuno}/${bean.board_name}/write.do">자원봉사신청</a></span>
											</td>
										</tr>
									</table>
									</form>
