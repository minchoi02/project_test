									...
									<table class="tbl" border="0" cellpadding="0" cellspacing="0" style="width: 95%;">
										...
										<tbody>
											<c:if test="${empty list}">
													<tr>
														<td colspan="7" style="text-align:center;">등록된 팝업이 없습니다.</td>
													</tr>
												</c:if>
												<c:if test="${!empty list}">
													<c:forEach var="listA" items="${list}">
															<tr>
															<td style="text-align: center;"><input type="checkbox" name="check_seq" id="check_seq${listA.SEQ}" value="${listA.SEQ}"></td>
															<td onclick="goView('${listA.SEQ}');" style="text-align: center;">
																<img src="/upload/data/${listA.FILENAME}" width="50px" height="50px">	
															</td>
															<td onclick="goView('${listA.SEQ}');" style="text-align: left;">${listA.TITLE}</td>
															<td onclick="goView('${listA.SEQ}');" style="text-align: center;">
																<fmt:formatDate value="${listA.GESI_SD}" pattern="yyyy-MM-dd" />
																~
																<fmt:formatDate value="${listA.GESI_ED}" pattern="yyyy-MM-dd" />
															</td>
															<td onclick="goView('${listA.SEQ}');" style="text-align: center;">
																<c:if test="${listA.USE_YN == 'Y'}">노출</c:if>
																<c:if test="${listA.USE_YN == 'N'}">미노출</c:if>
															</td>															
															<td onclick="goView('${listA.SEQ}');" style="text-align: center;">${listA.SORT}</td>
									...
									<table style="width: 95%;">
										...
										<tr>
											<td align="right" style="padding-top:5px;">
												...
												<span class="button01"><a href="/admin/${bean.menuno}/${bean.board_name}/board_write.do">팝업 등록</a></span>
											</td>
										</tr>
									</table>
									</form>
