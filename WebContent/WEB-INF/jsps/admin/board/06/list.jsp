												...
												<c:if test="${!empty list}">
													<c:forEach var="listA" items="${list}">
															...
															<td style="text-align: center;">
																<img src="/upload/data/${listA.FILENAME}" width="50px" height="50px" onerror='this.src="/assets/user/images/common/noimg.png"'>	
															</td>
															...
															<td style="text-align: center;">${listA.SORT}</td>
									...
									<table style="width: 95%;">
										...
										<tr>
											<td align="right" style="padding-top:15px;">
												<span class="button01"><a href="/admin/${bean.menuno}/${bean.board_name}/board_write.do">슬라이드 등록</a></span>
											</td>
										</tr>
									</table>
									</form>
