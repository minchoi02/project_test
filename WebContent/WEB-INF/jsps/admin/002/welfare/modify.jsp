										...
										<td colspan="3">
											...
											<c:forEach var="list" items="${selType1List}" varStatus="status">
												<label for="type1_${status.count}">
													<input type="checkbox" name="type_code" class="type1" id="type1_${status.count}" value="${list.SEQ}" <c:if test="${fn:contains(type_1, list.CODE_DESC)}">checked</c:if>/> ${list.CODE_DESC}
												</label>
											</c:forEach>
										</td>
									</tr>
										...
										<td colspan="3">
											...
											<c:forEach var="list" items="${selType3List}" varStatus="status">
												<label for="type3_${status.count}">
													<input type="checkbox" name="type_code" class="type3" id="type3_${status.count}" value="${list.SEQ}" <c:if test="${fn:contains(type_3, list.CODE_DESC)}">checked</c:if>/> ${list.CODE_DESC}
												</label>
											</c:forEach>
										</td>
									</tr>
										...
										<td colspan="3">
											...
											<c:forEach var="list" items="${selType4List}" varStatus="status">
												<label for="type4_${status.count}">
													<input type="checkbox" name="type_code" class="type4" id="type4_${status.count}" value="${list.SEQ}" <c:if test="${fn:contains(type_4, list.CODE_DESC)}">checked</c:if>/> ${list.CODE_DESC}
												</label>
											</c:forEach>
										</td>
									</tr>
										...
										<td colspan="3">
											...
											<c:forEach var="list" items="${selType5List}" varStatus="status">
												<label for="type5_${status.count}">
													<input type="checkbox" name="type_code" class="type5" id="type5_${status.count}" value="${list.SEQ}" <c:if test="${fn:contains(type_5, list.CODE_DESC)}">checked</c:if>/> ${list.CODE_DESC}
												</label>
											</c:forEach>
										</td>
									</tr>
										...
										<td colspan="3">
											...
											<c:forEach var="list" items="${selType6List}" varStatus="status">
												<label for="type6_${status.count}">
													<input type="checkbox" name="type_code" class="type6" id="type6_${status.count}" value="${list.SEQ}" <c:if test="${fn:contains(type_6, list.CODE_DESC)}">checked</c:if>/> ${list.CODE_DESC}
												</label>
											</c:forEach>
										</td>
									</tr>
