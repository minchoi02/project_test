...
public class ExcelDownLoadFile extends AbstractExcelView {
	...
	protected void buildExcelDocument(Map model, HSSFWorkbook workbook,
		...
		List<Map<String, Object>> colValue = (List<Map<String, Object>>) excelList.get("colValue");
		...
		for ( int i = 0; i < colValue.size(); i++ ) {
			createRow(sheet, (Map<String, Object>)colValue.get(i), i+1, colName);
		}
	...
	// 각 로우에 대한 값 입력
	private void createRow(HSSFSheet sheet, Map<String, Object> map, int rowNum, List<String> coln) {
		...
		for ( int i = 0 ; i < coln.size(); i++ ) {
			...
			String colnS = (String)coln.get(i);
			String colvS = (String)map.get(colnS);
			cell.setCellValue(colvS);
		}
	}
}
