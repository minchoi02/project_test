...
@Repository
public class FactoryDAO extends DefaultDAO{
	...
	public Map<String, Object> view(@Param("param")CommonMap param){
		return (Map<String, Object>)sqlSession.selectOne("factory.view" ,param);
	}
	...
	public List<Map<String, Object>> conList(@Param("param")CommonMap param){
		return (List<Map<String, Object>>)sqlSession.selectList("factory.conList",param);
	}

	public int conListCount(@Param("param")CommonMap param){
		return (int)sqlSession.selectOne("factory.conListCount",param);
	}
