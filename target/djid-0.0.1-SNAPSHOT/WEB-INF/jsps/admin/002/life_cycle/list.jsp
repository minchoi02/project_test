...
function goView(seq){
	...
	$("#frm_search_welfare_seq").val($("#search_welfare_seq").val());
...
<div id="contents_bg">
		...
		<div class="conBox">
				...
				<div class="T_basic">
						...
						<form name="searchForm" id="searchForm" method="post" action="/admin/002/life_cycle/list.do">
							...
							<table class="tbl" style="width:600px;border:0">
								...
								<tbody>
									<tr>
										<th><b>분류</b></th>
										<td>
										<select name="search_welfare_seq" id="search_welfare_seq" style="width:100%;min-width:100%;" >
											<option value="">전체</option>
											<c:forEach var="list" items="${selType8List}">
												<option value="${list.SEQ}" <c:if test="${list.SEQ != '' and list.SEQ == bean.search_welfare_seq}">selected="selected"</c:if>>${list.CODE_DESC}</option>
											</c:forEach>
										</select>	
										</td>										
										<th><b>검색어</b></th>
						...
						<tr valign="top">
							<td align="center" id="list_area_td">
								<div id="list_area_div">
									...
									<input type="hidden" name="search_welfare_seq" id="frm_search_welfare_seq" value="${bean.search_welfare_seq}" />
