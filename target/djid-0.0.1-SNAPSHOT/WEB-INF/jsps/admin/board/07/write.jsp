							...
							<table  class="tbv"  summary="공지사항 글입력하기">
								...
								<tbody>
									...
									<tr>
										...
										<td colspan="2">
											<input type="text" name="place" id="place" value="${view.PLACE }" style="width:100%;"> 
										</td>
									</tr>
									<tr>
										<th><label for="SCHEDULES">일정</label></th>
										<td colspan="2" style="text-align:left;">
											<input type="text" id="sdate" class="sdate" name="sdate" value="" size="20" width="20">
												~
											<input type="text" id="edate" class="edate" name="edate" value="" size="20" width="20"> 
										</td>
									</tr>
									<tr>
