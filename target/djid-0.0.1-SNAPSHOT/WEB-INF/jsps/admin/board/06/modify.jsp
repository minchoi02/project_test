...
$(document).ready(function(){
	...
	$('#videoDeleteCheck').change(function(){
							...
							<table  class="tbv"  summary="공지사항 글입력하기">
								...
								<tbody>
									...
									<tr>
										...
										<td colspan="2" style="text-align:left;">
											좌측 <input type="text" name="left" id="left" value="${view.LEFT}" style="width:50px" />
									...
									<tr>
										...
										<td colspan="2" style="text-align:left;">
											...
											<c:if test="${view.VIDEOOFILENAME ne null}">   
												&nbsp;&nbsp;<label for="videoDeleteCheck"> 
													<input type="checkbox" name="videoDeleteCheck" id="videoDeleteCheck" value="">삭제
												</label>
											</c:if>   
											<input type="hidden" name="videoDelete" id="videoDelete" value="0">
										</td>
									</tr>
								</tbody>
							</table>
