		...
		$.ajax({
		    ...
		    success: function(list){		    	
		    	...
		    	for (var i = 0; i < list.length; i++) {
					...
					var dongri_seq = "${view.AREA1_DONGRI_SEQ}";
					var selected = "";
					if(dongri_seq == seq){
						selected = "selected";
					}
		...
		$.ajax({
		    ...
		    success: function(list){		    	
		    	...
		    	for (var i = 0; i < list.length; i++) {
					...
					var dongri_seq = "${view.AREA2_DONGRI_SEQ}";
					var selected = "";
					if(dongri_seq == seq){
						selected = "selected";
					}
...
var edu_tr_cnt = ${fn:length(edu_list)};
...
var career_tr_cnt = ${fn:length(career_list)};
if(career_tr_cnt == 0){
	career_tr_cnt = 1;
}
				...
				<form name="frm" id="frm" method="post" action="/admin/${bean.menuno}/${bean.board_name}/update.do"  method="post" enctype="multipart/form-data" accept-charset="utf-8">
							...
							<table  class="tbv"  summary="공지사항 글입력하기" style="margin-top: 10px;">
								...
								<tbody>
									<tr>
										...
										<td>
											<input type="text" name="name" id="fname" value="${view.NAME}" style="width: 200px;" maxlength="20" size="20"/>																					
										</td>
									...
									<tr>
										...
										<td colspan="3">
											...
											<br/>
											<input type="text" name="addr2" id="addr2" value="${view.ADDR2}" style="width: 350px; margin-top: 5px;" maxlength="50" size="50"/>																							
										</td>
									</tr>
									<tr>
										...
										<th>이메일</th>
										<td>
											<input type="text" name="email1" id="email1" value="${view.EMAIL1}" style="width:100px;"> 
											@
											<input type="text" name="email2" id="email2" value="${view.EMAIL2}" style="width:120px;">
										</td>
									</tr>
									<tr>										
										...
										<td>
											<select name="kind_seq" id="kind_seq" style="width: 200px;">
												<c:forEach var="list" items="${selType4List}" varStatus="status">
													<option value="${list.SEQ}" <c:if test="${view.KIND_SEQ eq list.SEQ}">selected</c:if>>${list.CODE_DESC}</option>
												</c:forEach>
											</select>
										</td>
										<th>장애발생시기</th>
										<td>
											<input type="text" name="occur_date" id="occur_date" value="${view.OCCUR_DATE}" style="width:200px;" maxlength="50" size="50">
										</td>
									</tr>
									<tr>
										...
										<td>
											<select name="level_seq" id="level_seq" style="width: 200px;">
												<c:forEach var="list" items="${selType5List}" varStatus="status">
													<option value="${list.SEQ}" <c:if test="${view.LEVEL_SEQ eq list.SEQ}">selected</c:if>>${list.CODE_DESC}</option>
												</c:forEach>
											</select>
										</td>
										<th>장애등록일</th>
										<td>
											<input type="text" name="regist_date" id="regist_date" value="${view.REGIST_DATE}" style="width:200px;" maxlength="50" size="50">
										</td>
									</tr>
									<tr>
										<th>장애부위</th>
										<td>
											<input type="text" name="part" id="part" value="${view.PART}" style="width:200px;" maxlength="50" size="50">
										</td>
										<th>진료/치료</th>
										<td>
											<input type="text" name="cure" id="cure" value="${view.CURE}" style="width:200px;" maxlength="50" size="50">
										</td>
									</tr>
								</tbody>
							</table>
							...
							<table  class="tbv edu_table"  summary="공지사항 글입력하기" style="margin-top: 10px;">
								...
								<tbody id="edu_tbody">
									...
									<c:forEach var="list" items="${edu_list}" varStatus="status">
										<tr id="edu_tr${status.count}">
											<td><input type="text" name="edu_name" id="edu_name${status.count}" value="${list.EDU_NAME}" style="width:150px;" maxlength="50" size="50"></td>
											<td>
												<input type="text" class="cal" name="edu_sdate" id="edu_sdate${status.count}" value="<fmt:formatDate value="${list.EDU_SDATE}" pattern="yyyy-MM-dd" />" style="width:80px;" readonly="readonly"><img src="/assets/admin/images/cal2.png" width="25px" class="cal" alt="달력"/>
												~
												<input type="text" class="cal" name="edu_edate" id="edu_edate${status.count}" value="<fmt:formatDate value="${list.EDU_EDATE}" pattern="yyyy-MM-dd" />" style="width:80px;" readonly="readonly"><img src="/assets/admin/images/cal2.png" width="25px" class="cal" alt="달력"/>
											</td>
											<td><input type="text" name="edu_content" id="edu_content${status.count}" value="${list.EDU_CONTENT}" style="width:200px;" maxlength="50" size="50"></td>
											<td><input type="text" name="edu_etc" id="edu_etc${status.count}" value="${list.EDU_ETC}" style="width:160px;" maxlength="50" size="50"></td>
							...
							<table  class="tbv edu_table"  summary="공지사항 글입력하기" style="margin-top: 10px;">
								...
								<tbody id="career_tbody">
									...
									<c:forEach var="list" items="${career_list}" varStatus="status">
										<tr id="career_tr${status.count}">
											<td><input type="text" name="career_name" id="career_name${status.count}" value="${list.CAREER_NAME}" style="width:150px;" maxlength="50" size="50"></td>
											<td>
												<input type="text" class="cal" name="career_sdate" id="career_sdate${status.count}" value="<fmt:formatDate value="${list.CAREER_SDATE}" pattern="yyyy-MM-dd" />" style="width:80px;" readonly="readonly"><img src="/assets/admin/images/cal2.png" width="25px" class="cal" alt="달력"/>
												~
												<input type="text" class="cal" name="career_edate" id="career_edate${status.count}" value="<fmt:formatDate value="${list.CAREER_EDATE}" pattern="yyyy-MM-dd" />" style="width:80px;" readonly="readonly"><img src="/assets/admin/images/cal2.png" width="25px" class="cal" alt="달력"/>
											</td>
											<td><input type="text" name="career_content" id="career_content${status.count}" value="${list.CAREERU_CONTENT}" style="width:200px;" maxlength="50" size="50"></td>
											<td><input type="text" name="career_etc" id="career_etc${status.count}" value="${list.CAREER_ETC}" style="width:160px;" maxlength="50" size="50"></td>
							...
							<table  class="tbv"  summary="공지사항 글입력하기" style="margin-top: 10px;">
								...
								<tbody>
									<tr>
										<th>외모/청결상태</th>
										<td>
											<input type="text" name="life_ability1" id="life_ability1" value="${view.LIFE_ABILITY1}" style="width: 500px;"/>
										</td>
									</tr>
									<tr>
										<th>일상생활</th>
										<td>
											<input type="text" name="life_ability2" id="life_ability2" value="${view.LIFE_ABILITY2}" style="width: 500px;"/>
										</td>
									</tr>
									<tr>
										<th>이동능력(교통)</th>
										<td>
											<input type="text" name="life_ability3" id="life_ability3" value="${view.LIFE_ABILITY3}" style="width: 500px;"/>
										</td>
									</tr>
									<tr>
										<th>의사소통</th>
										<td>
											<input type="text" name="life_ability4" id="life_ability4" value="${view.LIFE_ABILITY4}" style="width: 500px;"/>
										</td>
									</tr>
									<tr>
										<th>대인관계</th>
										<td>
											<input type="text" name="life_ability5" id="life_ability5" value="${view.LIFE_ABILITY5}" style="width: 500px;"/>
										</td>
									</tr>
									<tr>
										<th>자격 및 면허</th>
										<td>
											<input type="text" name="life_ability6" id="life_ability6" value="${view.LIFE_ABILITY6}" style="width: 500px;"/>
										</td>
									</tr>
									<tr>
										<th>기타</th>
										<td>
											<input type="text" name="life_ability7" id="life_ability7" value="${view.LIFE_ABILITY7}" style="width: 500px;"/>
										</td>
									</tr>
								</tbody>
							</table>
							...
							<table  class="tbv"  summary="공지사항 글입력하기" style="margin-top: 10px;">
								...
								<tbody>
									<tr>
										...
										<td>
											<input type="text" name="sectors" id="sectors" value="${view.SECTORS}" style="width: 200px;"/>																					
										</td>
										<th><span style="color: red;">*</span> 응답</th>
										<td>
											<label for="response1"><input type="radio" name="response" id="response1" value="본인" <c:if test="${view.RESPONSE eq '본인'}">checked="checked"</c:if>>본인</label>
											<label for="response2"><input type="radio" name="response" id="response2" value="보호자" <c:if test="${view.RESPONSE eq '보호자'}">checked="checked"</c:if>>보호자</label>														
										</td>
									</tr>
									<tr>
										<th><span style="color: red;">*</span> 사유</th>										
										<td>
											<input type="text" name="reason" id="reason" value="${view.REASON}" style="width: 200px;"/>																					
										</td>
										<th><span style="color: red;">*</span> 성별</th>
										<td>
											<label for="sex1"><input type="radio" name="sex" id="sex1" value="남자" <c:if test="${view.SEX eq '남자'}">checked="checked"</c:if>>남자</label>
											<label for="sex2"><input type="radio" name="sex" id="sex2" value="여자" <c:if test="${view.SEX eq '여자'}">checked="checked"</c:if>>여자</label>																								
										</td>
									</tr>
									<tr>
										...
										<td>
											<select name="area1_gugun_seq" id="area1_gugun_seq" style="width: 80px;">
												<c:forEach var="list" items="${selType6List}" varStatus="status">
													<option value="${list.SEQ}" <c:if test="${view.AREA1_GUGUN_SEQ eq list.SEQ}">selected</c:if>>${list.CODE_DESC}</option>
												</c:forEach>
											</select>
										...
										<td>
											월 <input type="number" name="salary" id="salary" value="${view.SALARY}" placeholder="숫자" style="width: 50px;"/> 만원											 																					
										</td>
									</tr>
									<tr>
										...
										<td>
											<select name="area2_gugun_seq" id="area2_gugun_seq" style="width: 80px;">
												<c:forEach var="list" items="${selType6List}" varStatus="status">
													<option value="${list.SEQ}" <c:if test="${view.AREA2_GUGUN_SEQ eq list.SEQ}">selected</c:if>>${list.CODE_DESC}</option>
												</c:forEach>
											</select>
										...
										<td>
											<input type="number" name="shour" value="${view.SHOUR}" id="shour" max="23" min="0" placeholder="시" style="width: 50px;"/>
											:
											<input type="number" name="sminute" value="${view.SMINUTE}" id="sminute" max="0" min="59" placeholder="분" style="width: 50px;"/>
											~
											<input type="number" name="ehour" value="${view.EHOUR}" id="ehour" max="23" min="0" placeholder="시" style="width: 50px;"/>
											:
											<input type="number" name="eminute" value="${view.EMINUTE}" id="eminute" max="0" min="59" placeholder="분" style="width: 50px;"/>																												
										</td>
									</tr>
									<tr>
										<th>고용형태</th>										
										<td>
											<input type="text" name="emp" id="emp" value="${view.EMP}" style="width: 200px;"/>																					
										</td>
									...
									<tr>
										...
										<td colspan="3">
											<textarea name="content1" id="content1" rows="10" cols="80" placeholder="내용을 입력해주세요.">${view.CONTENT1}</textarea>																				
										</td>
									</tr>
									<tr>
										<th colspan="2"><span style="color: red;">*</span> 취업시 고려사항</th>
										<td colspan="3">
											<textarea name="content2" id="content2" rows="5" cols="80" placeholder="내용을 입력해주세요.">${view.CONTENT2}</textarea>																				
										</td>
									</tr>									
								</tbody>
							</table>
