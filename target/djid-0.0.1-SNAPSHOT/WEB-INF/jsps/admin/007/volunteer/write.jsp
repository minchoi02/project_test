							...
							<table  class="tbv" style="margin-top: 10px;"  summary="글입력하기">
								...
								<tbody>
									...
									<tr>
										<th>희망분야</th>
										<td>
											<input type="text" name="wanted_kind" id="wanted_kind" value="" style="width:200px;" maxlength="30" size="30"> 
										</td>
									</tr>
									<tr>
										<th>희망활동시간</th>
										<td>
											<input type="text" name="wanted_time" id="wanted_time" value="" style="width:200px;" maxlength="30" size="30"> 
										</td>
									</tr>
									<tr>
										<th>하고싶은말</th>
