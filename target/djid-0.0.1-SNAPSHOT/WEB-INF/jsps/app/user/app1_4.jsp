		...
		<header>
			<div class="header">
				<div class="homeBtnBox">
					<button type="button" class="btnHome"><em class="hidden">홈으로 이동</em></button>
				</div>
				<h1><span>정보드림</span>장애인 교통정보</h1>

				<div class="btnTabWrapper">
					<ul>
						<li><a href="#bus"><span>1호차</span></a></li>
						<li><a href="#" class="on"><span>2호차</span></a></li>
					</ul>
				</div>
			</div>
		</header>
		...
		<section>
			<div  class="trafficInformation">
				...
				<div class="currentInfoBox">
					...
					<p>차량정비중입니다. 자세한 문의는 하단 연락처로 연락부탁드립니다.</p>
				</div>
				...
				<div class="tabMenuWrapper">
					<div class="tabMenu num4">
						<div>
							<div class="btnTab"><a href="#freeShuttleBus2_1"><span>1차</span></a></div>
							<div class="btnTab"><a href="#freeShuttleBus2_2"><span>2차</span></a></div>
							<div class="btnTab"><a href="#freeShuttleBus2_3"><span>3차</span></a></div>
							<div class="btnTab"><a href="#freeShuttleBus2_4"><span>4차</span></a></div>
						</div>
					</div>
