					...
					<div class="contsArea communicationNotice">
						...
						<div class="commView">
							...
							<c:if test="${bean.board_name ne 'counseling'}">
								<div class="textInfo">
									<iframe src="/board/getContent.do?seq=${view.SEQ}&gubun=${view.BOARD_NAME}" style="width: 100%;overflow-x: hidden;overflow-y: hidden;" onload="setIFrameHeight(this);" title="게시글 내용"></iframe>
								</div>
							</c:if>
							...
							<c:if test="${bean.board_name eq 'counseling' and bean.answerYn eq 'Y'}">	
								...
								<div class="textInfoAnswer">
									<b>질문내용 : </b>
									<p><iframe src="/board/getContent.do?seq=${view.SEQ}&gubun=${view.BOARD_NAME}" style="width: 100%;overflow-x: hidden;overflow-y: hidden;" onload="setIFrameHeight(this);" title="게시글 내용"></iframe></p>
								</div>
								<!--//상담게시판 질문 -->
								<div class="textInfo">
									<p class="answer"></p>
							...
							<div class="layerWrapper confirmPassword" id="layerPassword2">
								<div class="layerBox">
									...
									<div class="layerBody">
										<div class="innerBox">
											<p class="formbox">
												<label for="delPwd">글 작성시 입력한 비밀번호를 입력해주세요.</label><input type="password" id="delPwd" name="pwd">
											</p>
											<div class="btnWrapper">
