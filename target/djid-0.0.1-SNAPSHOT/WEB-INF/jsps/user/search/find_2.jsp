			...
			<div class="innerBox">
							...
							<fieldset>
								...
								<div class="popularSearches">
									...
									<c:forEach var="list" items="${menu.list}">
										<a href="/search/find_1.do?keyword=${list.KEYWORD}">${list.KEYWORD}</a>
									</c:forEach>
								</div>
							</fieldset>
						</div>
				...
				<div class="searchResult">
					<div class="srchLeftBox">
						...
						<c:if test="${bean.gubun eq 'menu'}">
							<div class="subjectBox">
								<dl>
									<dt>메뉴  <em>(${totalCount}개)</em></dt>
									<dd>
						...
						<c:if test="${bean.gubun eq 'welfare'}">
							<div class="subjectBox">
								<dl>
									<dt>맞춤형 복지정보<em>(${totalCount}개)</em></dt>
									<dd>
										<c:forEach var="list" items="${list}">
											<a href="${list.LINK}" target="_blank">
						...
						<c:if test="${bean.gubun eq 'facility'}">
							<div class="subjectBox">
								<dl>
									<dt>우리지역 복지시설 <em>(${totalCount}개)</em></dt>
									<dd>
										<c:forEach var="list" items="${list}">
						...
						<c:if test="${bean.gubun eq 'board'}">
							<div class="subjectBox">
								<dl>
									<dt>게시판<em>(${totalCount}개)</em></dt>
									<dd>
										<c:forEach var="list" items="${list}">
								...
								<ul class="ranking">
									<c:forEach var="list" items="${searchList}" varStatus="status">
										<li>
											...
											<span><a href="/search/find_1.do?keyword=${list.KEYWORD}">${list.KEYWORD}</a></span>
										</li>
									</c:forEach>
								</ul>
							</dd>
