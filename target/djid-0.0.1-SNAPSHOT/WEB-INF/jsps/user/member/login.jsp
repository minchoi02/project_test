...
<link rel="stylesheet" href="/css/member.css">
    ...
    <div id="login-box">
        <div id="login_area">
            <form name="login_frm" method="post" onsubmit="return checks()" action="./member_action.php?mode=login">
            <fieldset id="login_fs" style="margin:0 auto;">
                ...
                <a href="./password_lost.php" id="login_password_lost" class="looginbtn">아이디/비밀번호 찾기</a><a href="/member/join_1.do" class="loginbtn">회원가입 하기</a>
                </div>
            </fieldset>
            </form>
        </div>
