...
<div id="wrapper">
	...
	<div id="container">
        ...
        <section id="videoclipView" class="page-content">
            <div class="video-clip-view floats">
                <div class="video-clip">
                    <div class="video-view-box">
	                    <div class="embed-container">
	                        <video id="my-video" controls autoplay="false" preload="auto" data-setup="{}" > <!-- class="video-js vjs-big-play-button vjs-fluid vjs-time-control" -->
								<source src="http://www.벌곡면주민자치회.kr/1483b1b3c1734dfc95c27f2ab4afc4c9.mp4" type="video/mp4"/>
							</video>
						  	<!--<script src="https://vjs.zencdn.net/7.10.2/video.min.js"></script>-->
					  	</div>
                    </div>
                    <div class="clip-choice-box">
                        <a href="#;" class="btns darkGrayBtn">CH-1</a>
                        <a href="#;" class="btns violetBtn">CH-2</a>
                        <a href="#;" class="btns darkGrayBtn">CH-3</a>
                        <a href="#;" class="btns darkGrayBtn">CH-4</a>
                    </div>
                </div>
            </div>
        </section>
